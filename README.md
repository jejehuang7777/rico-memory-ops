...
coherent judgment over time
memory that preserves identity-level working style, not just facts
...
See docs/PUBLIC_PRIVATE_BOUNDARY.md for publishing boundaries and transformation rules.
Roadmap
v0
